...
```{r}
# Generate random sample of 10,000 rows
...
```{r}
# Prior Model for High Blood Pressure
...
# Plot Observed Proportion of Diabetes
diabetes_sample %>% 
...
```{r}
# View Posterior Diagnostic Plots
...
```{r}
# Credible Interval for Posterior Plots
...
```{r}
# Check Accuracy of Simulated Data
...
```{r}
# Measure CV Accuracy with cutoff=0.45
set.seed(84735)
